...
function handleHeader(){
    ...
    echo "<h1>Brody Hausman</h1><div class="buttons"> - 
    ...
    <button class="nav-button" onclick="window.location.href = 'https://rhit-hausmabq.github.io/portfolio.html'">Portfolio</button></div>";
};
